...
export const ACTIVITIES: ActivityItem[] = [
  { when: '2026/08', ja: 'セキュリティ・キャンプ 全国大会 2026 専門C 脅威解析クラス修了', en: 'Completed Security Camp National Convention 2026, Specialized C Threat Analysis Class' },
  { when: '2026/08', ja: 'セキュリティ・キャンプ 2026 ミニ（茨城開催）にチューターとして参加', en: 'Participated as a tutor at Security Camp 2026 Mini (Ibaraki)' },
  ...
  { when: '2026/03', ja: 'セキュリティ・キャンプ 2026 コネクト デバイスクラス修了', en: 'Completed Security Camp Connect 2026, Device Class' },
